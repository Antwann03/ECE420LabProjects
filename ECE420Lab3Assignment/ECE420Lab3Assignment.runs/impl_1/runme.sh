...
HD_PWD='C:/ECE420/ECE420Lab3Assignment/ECE420Lab3Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FAdder.tcl -notrace

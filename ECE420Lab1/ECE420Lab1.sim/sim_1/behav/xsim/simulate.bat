...
REM
REM Generated by Vivado on Thu Jan 23 19:11:52 -0800 2025
...
call xsim  Counters_TB_behav -key {Behavioral:sim_1:Functional:Counters_TB} -tclbatch Counters_TB.tcl -log simulate.log
